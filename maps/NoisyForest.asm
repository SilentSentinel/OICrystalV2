NoisyForest_MapScriptHeader:
	...
	object_event 24, 31, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, PIKACHU, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, NoisyForestPikabluScript, EVENT_NOISY_FOREST_PIKABLU
	...
	tmhmball_event 17, 23, TM_SOUL_BIND, EVENT_NOISY_FOREST_TM_SOUL_BIND
...
NoisyForestPikabluScript:
	showcrytext .PikabluText, PIKACHU
