...
.MetGrandpa:
	...
	iffalse_jumpopenedtext BillsGrandpaYouDontHaveItTextText
	ifnotequal PLUPPY, .WrongPokemon
...
.GotLeafStone:
	...
	special Special_BillsGrandfather
	iffalse_jumpopenedtext BillsGrandpaYouDontHaveItTextText
	ifnotequal SHELLDER, .WrongPokemon
	scall .CorrectPokemon
...
.GotWaterStone:
	...
	special Special_BillsGrandfather
	iffalse_jumpopenedtext BillsGrandpaYouDontHaveItTextText
	ifnotequal TOULAV, .WrongPokemon
	scall .CorrectPokemon
...
.GotThunderstone:
	...
	special Special_BillsGrandfather
	iffalse_jumpopenedtext BillsGrandpaYouDontHaveItTextText
	ifnotequal TARSEER, .WrongPokemon
	scall .CorrectPokemon
...
.GotMoonStone:
	...
	special Special_BillsGrandfather
	iffalse_jumpopenedtext BillsGrandpaYouDontHaveItTextText
	ifnotequal PHAIRIS, .WrongPokemon
	scall .CorrectPokemon
...
.GotSunStone:
	...
	special Special_BillsGrandfather
	iffalse_jumpopenedtext BillsGrandpaYouDontHaveItTextText
	ifnotequal MISDREAVUS, .WrongPokemon
	scall .CorrectPokemon
...
.GotDuskStone:
	...
	special Special_BillsGrandfather
	iffalse_jumpopenedtext BillsGrandpaYouDontHaveItTextText
	ifnotequal FELARE, .WrongPokemon
	scall .CorrectPokemon
...
BillsGrandpaTogepiText:
	...
	para "appears in female"
	line "form?"

	para "There used to be"
	line "male versions, but"
	cont "they are gone."
	done
...
BillsGrandpaOddishText:
	text "Ah, my grandson"
	line "mentioned a small,"

	para "green #mon"
	line "that has petals"
	cont "on its head."
	done
