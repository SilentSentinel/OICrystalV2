...
.MenuData2:
	db $80 ; flags
	db 4 ; items
	db "Serinavi   {d:CELADONGAMECORNERPRIZEROOM_MR__MIME_COINS}@"
	db "Ion        {d:CELADONGAMECORNERPRIZEROOM_EEVEE_COINS}@"
	db "Gri        {d:CELADONGAMECORNERPRIZEROOM_PORYGON_COINS}@"
	db "Cancel@"
