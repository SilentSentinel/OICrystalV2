...
CyndaquilPokeBallScript:
	...
	promptbutton
	waitsfx
	givepoke MEWTWO, NO_FORM, 100, ARMOR_SUIT
	...
	opentext
	getmonname KOALEAF, STRING_BUFFER_3
...
TotodilePokeBallScript:
	...
	promptbutton
	waitsfx
	givepoke PATTLE, NO_FORM, 5, ORAN_BERRY
	writetext LyraChoosesStarterText
	waitbutton
	closetext
	...
	disappear ELMSLAB_POKE_BALL1
	opentext
	getmonname PYROO, STRING_BUFFER_3
	writetext LyraReceivedStarterText
	playsound SFX_CAUGHT_MON
	waitsfx
	promptbutton
...
ChikoritaPokeBallScript:
	...
	promptbutton
	waitsfx
	givepoke KOALEAF, NO_FORM, 5, ORAN_BERRY
	writetext LyraChoosesStarterText
	waitbutton
	closetext
	...
	disappear ELMSLAB_POKE_BALL2
	opentext
	getmonname PATTLE, STRING_BUFFER_3
	writetext LyraReceivedStarterText
	playsound SFX_CAUGHT_MON
	waitsfx
	promptbutton
