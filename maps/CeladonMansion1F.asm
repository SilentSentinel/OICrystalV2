CeladonMansion1F_MapScriptHeader:
	...
	pokemon_event  2,  6, GRI, -1, -1, PAL_NPC_BROWN, CeladonMansion1FMeowthText, -1
	pokemon_event  3,  4, TARSEER, -1, -1, PAL_NPC_RED, CeladonMansion1FClefairyText, -1
	pokemon_event  4,  4, FELARE, -1, -1, PAL_NPC_BLUE, CeladonMansion1FNidoranFText, -1
