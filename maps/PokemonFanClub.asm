PokemonFanClub_MapScriptHeader:
	...
	def_object_events
	object_event  3,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, TARSEER, -1, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptext, ClefairyDollText, EVENT_VERMILION_FAN_CLUB_DOLL
	...
	pokemon_event  7,  3, PHAIRIS, -1, -1, PAL_NPC_GREEN, FanClubOddishText, -1
