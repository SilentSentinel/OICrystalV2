IvysLab_MapScriptHeader:
	...
	object_event  5,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, TOTOTEM, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, IvysLabNidorinoScript, -1
...
.Healed:
	showcrytext IvysLabNidorinoText, TOTOTEM
	end
