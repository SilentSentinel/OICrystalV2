OlivineLighthouse6F_MapScriptHeader:
	...
	object_event  9,  8, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, HELIDRA, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, OlivineLighthouseAmphy, -1
...
UnknownScript_0x60c51:
	showcrytext AmphyPaluPaluluText, HELIDRA
	special FadeOutPalettes
	special LoadMapPalettes
	special FadeInPalettes
	special FadeOutPalettes
