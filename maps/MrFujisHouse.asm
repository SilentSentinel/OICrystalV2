MrFujisHouse_MapScriptHeader:
	...
	pokemon_event  8,  4, ONTLAM, -1, -1, PAL_NPC_BROWN, MrFujisPsyduckText, -1
	pokemon_event  5,  5, MIDONINJA, -1, -1, PAL_NPC_PURPLE, MrFujisNidorinoText, -1
	pokemon_event  1,  3, PIPUN, -1, -1, PAL_NPC_BROWN, MrFujisPidgeyText, -1
