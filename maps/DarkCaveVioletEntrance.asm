DarkCaveVioletEntrance_MapScriptHeader:
	...
	def_object_events
	object_event 10,  2, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, VOLTERRA, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_DARK_CAVE_URSARING
