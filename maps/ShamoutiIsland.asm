ShamoutiIsland_MapScriptHeader:
	...
	def_object_events
	object_event 16,  8, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, DRYLAC, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ShamoutiIslandVileplumeScript, EVENT_SHAMOUTI_ISLAND_VILEPLUME
	...
	pokemon_event 25, 14, PIKACHU, -1, -1, PAL_NPC_BLUE, ShamoutiIslandPikabluText, EVENT_SHAMOUTI_ISLAND_PIKABLU_GUY
