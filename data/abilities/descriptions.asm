AbilityDescriptions:
	...
	dw PistonKicksDescription
	dw RefrigerateDescription
	dw AerilateDescription
	dw SpitefulDescription
	dw StrongJawDescription
	dw DesecrateDescription
	dw FirePowerDescription
	dw RayBlasterDescription
	dw InvertigoDescription
	dw ShredderDescription
	dw FortissimoDescription
	dw GiantTailDescription
...
DesecrateDescription:
	db    "Normal-type moves"
	next1 "become Dark-type.@"

FirePowerDescription:
	db    "NVE moves made"
	next1 "strong with fire.@"

RayBlasterDescription:
	db    "Powers up beam"
	next1 "and blast moves.@"

InvertigoDescription:
	db    "Inverts time when"
	next1 "switched in.@"
...
FortissimoDescription:
	db    "Supercharges"
	next1 "Sound attacks.@"

GiantTailDescription:
	db    "Boosts power of"
	next1 "tail moves.@"
