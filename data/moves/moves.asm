...
endc
	...
	move THUNDER_TAIL, EFFECT_NORMAL_HIT,         90, ELECTRIC,   90, 10,   0, PHYSICAL
	...
	move FLASH,        EFFECT_PRIORITY_HIT,       50, FAIRY,     100, 20,   0, PHYSICAL
	move FEATHERSTORM, EFFECT_ACCURACY_DOWN_HIT,  85, FLYING,    100, 15,  20, SPECIAL
...
endc
	...
	move PYRO_REND,    EFFECT_NORMAL_HIT,         90, FIRE,      100, 15,   0, PHYSICAL
	...
	move SAND_WAVE,    EFFECT_ACCURACY_DOWN_HIT,  65, GROUND,    100, 20,  20, SPECIAL
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,    100, 20,   0, STATUS
	move DUST_DEVIL,   EFFECT_ACCURACY_DOWN_HIT, 110, GROUND,     80, 10,  20, SPECIAL
...
endc
	move DECIMATE,     EFFECT_DEFENSE_DOWN_HIT,  120, DARK,       85,  5,  30, PHYSICAL
	move MAGNITUDE,    EFFECT_MAGNITUDE,           1, GROUND,    100, 30,   0, PHYSICAL
	move SOUL_BIND,    EFFECT_CONFUSE_HIT,        90, GHOST,      95, 10,  20, PHYSICAL
