...
; entries correspond to constants/move_constants.asm
	...
	dw BattleAnim_Decimate
	dw BattleAnim_Magnitude
	dw BattleAnim_SoulBind
...
;Thunder Tail animation repurposed from ChattyCrystal Volt Tackle
BattleAnim_ThunderTail:
...
;Signal Beam animation from ChattyCrystal
...
; Fire Fang animation from ChattyCrystal
BattleAnim_FireFang:
...
; Bind animation reused for Soul Bind
BattleAnim_SoulBind:
	anim_1gfx ANIM_GFX_ROPE
	anim_sound 0, 1, SFX_BIND
	anim_obj ANIM_OBJ_BIND1, -16, 4,   8, 0, $0
