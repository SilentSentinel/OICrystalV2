...
DecorationAttributes:
	...
	decoration DECO_POSTER,   TOULAV,            SET_UP_POSTER,      EVENT_DECO_POSTER_2,                $6e
	decoration DECO_POSTER,   LEPSKI,            SET_UP_POSTER,      EVENT_DECO_POSTER_3,                $6f
	...
	decoration DECO_BIGDOLL,  ILLUMBRA,          SET_UP_BIG_DOLL,    EVENT_DECO_BIG_SNORLAX_DOLL,        SPRITE_BIG_SNORLAX
	...
	decoration DECO_DOLL,     TOULAV,            SET_UP_DOLL,        EVENT_DECO_CLEFAIRY_DOLL,           SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     TARSEER,           SET_UP_DOLL,        EVENT_DECO_JIGGLYPUFF_DOLL,         SPRITE_MON_DOLL_1
	...
	decoration DECO_DOLL,     KOALEAF,           SET_UP_DOLL,        EVENT_DECO_CHIKORITA_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     PYROO,             SET_UP_DOLL,        EVENT_DECO_CYNDAQUIL_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     PATTLE,            SET_UP_DOLL,        EVENT_DECO_TOTODILE_DOLL,           SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     TAROXIN,           SET_UP_DOLL,        EVENT_DECO_POLIWAG_DOLL,            SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     GRI,               SET_UP_DOLL,        EVENT_DECO_MAREEP_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     PHAIRIS,           SET_UP_DOLL,        EVENT_DECO_TOGEPI_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     MAGIKARP,          SET_UP_DOLL,        EVENT_DECO_MAGIKARP_DOLL,           SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     VENAP,             SET_UP_DOLL,        EVENT_DECO_ODDISH_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     KUSHINOBI,         SET_UP_DOLL,        EVENT_DECO_GENGAR_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     TARSAYER,          SET_UP_DOLL,        EVENT_DECO_OCTILLERY_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     DITTO,             SET_UP_DOLL,        EVENT_DECO_DITTO_DOLL,              SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     VOLTOT,            SET_UP_DOLL,        EVENT_DECO_VOLTORB_DOLL,            SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     MIRAI,             SET_UP_DOLL,        EVENT_DECO_ABRA_DOLL,               SPRITE_MON_DOLL_1
	...
	decoration DECO_DOLL,     KORSING,           SET_UP_DOLL,        EVENT_DECO_PINECO_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     LEPSKI,            SET_UP_DOLL,        EVENT_DECO_MARILL_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RHINOLT,           SET_UP_DOLL,        EVENT_DECO_TEDDIURSA_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     PIPUN,             SET_UP_DOLL,        EVENT_DECO_MEOWTH_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     VULPIX,            SET_UP_DOLL,        EVENT_DECO_VULPIX_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     SHREEK,            SET_UP_DOLL,        EVENT_DECO_GROWLITHE_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     ION,               SET_UP_DOLL,        EVENT_DECO_EEVEE_DOLL,              SPRITE_MON_DOLL_1
