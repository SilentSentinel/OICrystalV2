...
WonderTradeOTGenders2:
	...
	;       Eusine,  Kamerin, Earl,    Kurt,    Ben,     Mary,    Reed,    Fern
	...
	;       Miki,    SS,      Kiyo,    Scott,   Briney,  Stone,   Wanda,   Gabby
	...
	;       Rosanne, Julia,   Jordan,  Dexter,  Addie,   Fuego,   Helena,  Hawes
	...
	;       Baba,    Haas,    Paul,    Cyan,    Ace,     Everyle, Zetsu,   Karuta
	genders FEMALE,  MALE,    MALE,    FEMALE,  MALE,    MALE,    MALE,    MALE
	;       Nozomi,  Amos,    Kaito,   Meiko,   Miku,    Rin,     Pikang,  Luka
	genders FEMALE,  MALE,    MALE,    FEMALE,  FEMALE,  FEMALE,  MALE,    FEMALE
	;       Teto,    Ami,     Minako,  Usagi,   Lei,     Makoto,  Mamoru,  Luna
	...
	;       Styg,    Yui,     Kaworu,  Roxas,   Daru,    Kurisu,  Suzuha,  Mayuri
	genders MALE,    FEMALE,  MALE,    MALE,    MALE,    FEMALE,  FEMALE,  FEMALE
	;       Ruka,    Kyon,    Haruhi,  Yuki,    Kitsu,   Suzu,    Korra,   Itsuki
	...
	;       Rhue,    Traziun, Gaius,   Lyrra,   Kloe,    Cetsa,   Lexus,   Shand
	genders MALE,    MALE,    MALE,    FEMALE,  FEMALE,  FEMALE,  FEMALE,  FEMALE
	;       Strata,  Slade,   Dirk,    Talan,   Kersh,   Rangi,   Remy,    Sylvie
	genders MALE,    MALE,    MALE,    MALE,    MALE,    FEMALE,  MALE,    FEMALE
	;       Matthew, Katie,   Babs,    Mex,     Aizawa,  Suki,    Fredrik, Drayano
	genders MALE,    FEMALE,  FEMALE,  FEMALE,  FEMALE,  FEMALE,  MALE,    MALE
	;       Novi,    Marckus, SR,      TX,      TMM,     AKP,     Satoru,  Iwata
	genders FEMALE,  MALE,    MALE,    MALE,    MALE,    MALE,    MALE,    MALE
	;       Junichi, Masuda,  Pojo,    Nishino, Sosuke,  Tamada,  Hisashi, Sogabe
	genders MALE,    MALE,    MALE,    MALE,    MALE,    MALE,    MALE,    MALE
	;       Chron,   Kagaya,  Yoshi,   Matsuda, Shigeki, Tetsuya, Oota,    HAASHOLE
	genders MALE,    MALE,    MALE,    MALE,    MALE,    MALE,    MALE,    MALE
