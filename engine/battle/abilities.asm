...
BattleEntryAbilities:
	...
	dbw INVERTIGO, InvertigoAbility
	; fallthrough
StatusHealAbilities:
...
InvertigoAbility:
	...
	ld de, TRICK_ROOM
	farcall Call_PlayBattleAnim
	farcall BattleCommand_trickroom
	jmp EnableAnimations
...
OffensiveDamageAbilities_AfterTypeMatchup:
	...
	dbw FIRE_POWER, FirePowerAbility
	dbw -1, -1
...
OffensiveDamageAbilities:
	...
	dbw PISTON_KICKS, PistonKicksAbility
	dbw REFRIGERATE, RefrigerateAbility
	dbw AERILATE, AerilateAbility
	dbw STRONG_JAW, StrongJawAbility
	dbw DESECRATE, DesecrateAbility
	dbw RAY_BLASTER, RayBlasterAbility
	dbw SHREDDER, ShredderAbility
	dbw FORTISSIMO, FortissimoAbility
	dbw GIANT_TAIL, GiantTailAbility
	dbw -1, -1
...
DefensiveDamageAbilities:
	...
	dbw TOUGH_HIDE, EnemyToughHideAbility
	dbw -1, -1
...
PistonKicksAbility:
; 130% damage for kicking moves
	ld hl, KickingMoves
	ln b, 13, 10 ; x1.3
	jr MoveBoostAbility

INCLUDE "data/moves/kicking_moves.asm"
...
INCLUDE "data/moves/biting_moves.asm"
...
INCLUDE "data/moves/blaster_moves.asm"

ShredderAbility:
; 150% damage for cutting moves
	ld hl, CuttingMoves
	ln b, 3, 2 ; x1.5
	jr MoveBoostAbility

INCLUDE "data/moves/cutting_moves.asm"

FortissimoAbility:
; Double damage for sound damaging moves
	ld hl, FortMoves
	ln b, 2, 1 ; x2
	jr MoveBoostAbility

INCLUDE "data/moves/fort_moves.asm"

GiantTailAbility:
; 130% damage for tail moves
	ld hl, TailMoves
	ln b, 13, 10 ; x1.3
	jr MoveBoostAbility

INCLUDE "data/moves/tail_moves.asm"
