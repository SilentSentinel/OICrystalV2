...
; used by PokemonActionSubmenu (see engine/pokemon/mon_menu.asm)
	...
	const MONMENUITEM_DIG        ; 7
	const MONMENUITEM_TELEPORT   ; 8
	const MONMENUITEM_FRESHSNACK ; 9
	const MONMENUITEM_HEADBUTT   ; 10
	const MONMENUITEM_ROCKSMASH  ; 11
	; options
	const MONMENUITEM_STATS      ; 12
	const MONMENUITEM_SWITCH     ; 13
	const MONMENUITEM_ITEM       ; 14
	const MONMENUITEM_CANCEL     ; 15
	const MONMENUITEM_MOVE       ; 16
